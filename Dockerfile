...
COPY --from=builder /home/root/build/libs/sejni.jar /home/root/app/
EXPOSE 8080
ENTRYPOINT  ["java", "-Djava.security.egd=file:/dev/./urandom", "-jar", "sejni.jar", "--spring.config.location=classpath:file:./config/"]